...
var hui = (function(selector, undefined){
	...
	huibase.loading = function(msg, isClose){
		...
		if(!HUI_LoadingMask){
			...
			HUI_LoadingMask.innerHTML = '<div id="hui-loading"  style="z-index: 999999999;"><div id="hui-loading-in"><div></div><div></div><div></div><div></div><div></div></div>'+loadingText+'</div>';
